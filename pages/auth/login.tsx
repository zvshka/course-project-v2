    ...
    return <div className="min-h-screen bg-gradient-to-tl from-secondary to-indigo-900 w-full py-16 px-4">
        <div className="flex flex-col items-center justify-center">
            ...
            <div className="bg-white shadow rounded lg:w-1/3 md:w-1/2 w-full p-10 mt-16">
                <p tabIndex={0} className="focus:outline-none text-2xl font-extrabold leading-6 text-gray-800">Вход в
                    аккаунт</p>
                ...
                <div className="mt-8">
                    <button role="button"
                            ...
                            leading-none text-white focus:outline-none bg-indigo-700 border rounded hover:bg-indigo-600 py-4 w-full">Войти
                    </button>
                </div>
            </div>
        </div>
