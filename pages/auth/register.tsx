    ...
    return <div className="min-h-screen bg-gradient-to-tl from-secondary to-indigo-900 w-full py-16 px-4">
        <div className="flex flex-col items-center justify-center">
            ...
            <div className="bg-white shadow rounded lg:w-1/3 md:w-1/2 w-full p-10 mt-16">
                <p tabIndex={0}
                   className="focus:outline-none text-2xl font-extrabold leading-6 text-gray-800">Регистрация</p>
                <p tabIndex={0} className="focus:outline-none text-sm mt-4 font-medium leading-none text-gray-500">
                    Есть аккаунт?
                    <Link href={"/auth/login"}>
                        <a className="hover:text-gray-500 focus:text-gray-500 focus:outline-none focus:underline
                        hover:underline text-sm font-medium leading-none  text-gray-800 cursor-pointer"> Вход</a>
                    </Link>
                </p>
                ...
                <div className="mt-6 w-full">
                    <label htmlFor="passAgain" className="text-sm font-medium leading-none text-gray-800">
                        Пароль еще раз
                    </label>
                    <div className="relative flex items-center justify-center">
                        <input id="pass" type="password"
