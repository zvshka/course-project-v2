...
import { Sun, Phone, At } from 'tabler-icons-react';
...
const MOCKDATA = [
    { title: 'Email', description: 'pushpurs@yandex.ru', icon: At },
    { title: 'Телефон', description: '+7 (990) 322 69 69', icon: Phone },
    // { title: 'Address', description: '844 Morris Park avenue', icon: MapPin },
    { title: 'Рабочее время', description: 'Почти всегда)', icon: Sun },
];
